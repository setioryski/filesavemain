            ...
            <table class="file-manager-table">
                ...
                <tbody>
                    ...
                    <tr class="file" data-file="<?= htmlspecialchars($result) ?>">
                        ...
                        <?php if (preg_match('/\.(xls|xlsx)$/i', $result)): ?>
                            <a href="preview_excel.php?file=<?= urlencode($result) ?>" target="_blank" class="btn orange"><i class="fa-solid fa-eye fa-xs"></i> Preview</a>
                            <?php endif; ?>
                     <?php endif; ?>
                    </td>
